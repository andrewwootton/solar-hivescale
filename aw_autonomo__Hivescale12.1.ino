/* aw_autonomo_Hivescale12.1
   9/8/16
   revised TPH code for V2 including Adafruit libraries
...
#define DATA_HEADER "Date/Time, Temperature, Pressure, Altitude, Humidity, Weight, Battery"   //Data header
