/* aw_autonomo_Hivescale4
   21/6/16 latest 21/6/16
   2 scales connected via separate HX711 amplifiers
   power down/up hx711
...
#define calibration_factor2 -21500.0 //This value is obtained using the SparkFun_HX711_Calibration sketch
#define zero_factor2 8350277 //This large value is obtained using the SparkFun_HX711_Calibration sketch

#define DOUT  10  //use D10/D11 always on Grove connector for connection to HX711 #1
#define CLK  11
#define DOUT2  0  //use D0/D1 always on Grove connector for connection to HX711 #2
#define CLK2  1
...
#define WRITE_API_KEY "OQRYAS2Y0G0H56P0" //channel key for Autonomo
